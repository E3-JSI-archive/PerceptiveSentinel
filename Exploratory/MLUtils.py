...
class Predictor:
    ...
    def test_classifier(self, X, Y):
        ...
        return (precission, recall, f1), self.revert_labels(predicted_labels, X.shape)
...
def train_test_classifier(X, Y,
    ...
    def flatten_data(data):
        ...
        return data.reshape(full_size, initial_data_shape[-1]), (initial_shape, full_size)
    ...
    #test_label_mask_predictions = np.concatenate((train_labels, cv_labels, predicted_labels)).reshape(initial_label_shape)
